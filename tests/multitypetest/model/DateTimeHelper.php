...
class DateTimeHelper
{
    ...
    public static function toSimpleDateArray($dates)
    {
        ...
        return array_map(static::class . '::toSimpleDate', $dates);
    }
    ...
    public static function fromSimpleDateArray($dates)
    {
        ...
        return array_map(static::class . '::fromSimpleDate', $dates);
    }
    ...
    public static function fromSimpleDateMap($datetimes)
    {
        ...
        return array_map(static::class . '::fromSimpleDate', $array);
    }
    ...
    public static function toRfc1123DateTimeArray($datetimes)
    {
        ...
        return array_map(static::class . '::toRfc1123DateTime', $datetimes);
    }
    ...
    public static function fromRfc1123DateTimeArray($datetimes)
    {
        ...
        return array_map(static::class . '::fromRfc1123DateTime', $datetimes);
    }
    ...
    public static function fromRfc1123DateTimeMap($datetimes)
    {
        ...
        $array = json_decode(json_encode($datetimes), true);
        return array_map(static::class . '::fromRfc1123DateTime', $array);
    }
    ...
    public static function toRfc3339DateTimeArray($datetimes)
    {
        ...
        return array_map(static::class . '::toRfc3339DateTime', $datetimes);
    }
    ...
    public static function fromRfc3339DateTimeArray($datetimes)
    {
        ...
        return array_map(static::class . '::fromRfc3339DateTime', $datetimes);
    }
    ...
    public static function fromRfc3339DateTimeMap($datetimes)
    {
        ...
        $array = json_decode(json_encode($datetimes), true);
        return array_map(static::class . '::fromRfc3339DateTime', $array);
    }
    ...
    public static function toUnixTimestampArray($datetimes)
    {
        ...
        return array_map(static::class . '::toUnixTimestamp', $datetimes);
    }
    ...
    public static function fromUnixTimestampArray($datetimes)
    {
        ...
        return array_map(static::class . '::fromUnixTimestamp', array_map('strval', $datetimes));
    }
    ...
    public static function fromUnixTimestampMap($datetimes)
    {
        ...
        $array = json_decode(json_encode($datetimes), true);
        return array_map(static::class . '::fromUnixTimestamp', array_map('strval', $array));
    }
}
